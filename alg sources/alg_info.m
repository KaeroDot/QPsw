...
% Part of QWTB. Info script for algorithm QPSDEMULT. %
% See also qwtb

alginfo.id = 'QPSDEMULT';
alginfo.name = 'QuPoS demultiplexer';
alginfo.desc = 'Demultiplex the waveforms measured by QuPoS';
alginfo.citation = 'see EMRP QPower';
alginfo.remarks = '';
